    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="flex gap-3">
          {SENTIMENT_CHART_COLORS.map((color, i) => (
            <div key={i} className="text-center">
              <div
                className="w-16 h-16 rounded-lg shadow-sm border"
                style={{ backgroundColor: color }}
              />
              <p className="text-xs text-muted-foreground mt-2">{i + 1}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div>
        <h3 className="text-lg font-semibold mb-4">
          NPS Scale (0 = detractor → 10 = promoter)
        </h3>
        <div className="flex gap-1">
          {NPS_SCALE_COLORS.map((color, i) => (
            <div key={i} className="text-center flex-1">
              <div
                className="h-10 rounded-sm shadow-sm border"
                style={{ backgroundColor: color }}
              />
              <p className="text-xs text-muted-foreground mt-1">{i}</p>
            </div>
          ))}
        </div>
      </div>
