...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'ImageAreaSelector: a single- or multiple-answer question where the respondent selects parts of an image. Unlike ImageAreaEvaluator there are no choices or categories — clicking an area simply toggles it selected. A selected area mirrors the Card image-only selected treatment (also used by ImageAreaEvaluator): a solid outer border in the brand primary color that hugs the image frame exactly like the hover ring does, a white ring just inside it, and a low-opacity fill of that same primary color. Compose with QuestionText for the question label and error message.\n\n' +
