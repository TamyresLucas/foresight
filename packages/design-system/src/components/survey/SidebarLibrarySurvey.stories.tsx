...
const meta = {
    title: 'Survey Builder/Build/SidebarLibrarySurvey',
    component: SidebarLibrarySurveyMock,
    parameters: {
        docs: {
            description: {
                component: `
**SidebarLibrarySurvey** is a draggable row in the survey library sidebar. Each row represents a saved survey that can be dragged into the canvas or expanded to reveal its contents. It extends the \`SidebarToolboxItem\` shape — the question-type icon is replaced by a \`content_paste\` (clipboard) icon, and a \`ChevronRight\` button is always visible as the trailing action.
