...
const iconMap: Record<string, React.ElementType> = {
  ...
  "Image Choice Grid": ChoiceGridIcon,
  ...
  "Image Area Evaluator": ImageSelectorIcon,
  "Image Area Selector": ImageSelectorIcon,
  "Image Grid": ImageSelectorIcon,
  "Image Selector": ImageSelectorIcon,
...
export const questionGroups: Record<string, string[]> = {
  ...
  Grid: ["Choice Grid", "Custom Grid", "Image Choice Grid", "Image Grid", "Running Total"],
