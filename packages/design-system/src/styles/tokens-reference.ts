...
export const STATIC_TOKENS: Record<string, StaticTokenValue> = {
  ...
  "chart-9": {
    ...
    light: "291 50% 60%",
    dark: "291 50% 60%",
    originalFormula: "orchid (#BC65CC)",
  },
  "chart-9-lighter": { variable: "--chart-9-lighter", light: "291 50% 76%", dark: "291 50% 76%", originalFormula: "orchid +16% L" },
  "chart-9-light":   { variable: "--chart-9-light",   light: "291 50% 68%", dark: "291 50% 68%", originalFormula: "orchid +8% L" },
  "chart-9-dark":    { variable: "--chart-9-dark",    light: "291 50% 52%", dark: "291 50% 52%", originalFormula: "orchid −8% L" },
  "chart-9-darker":  { variable: "--chart-9-darker",  light: "291 50% 44%", dark: "291 50% 44%", originalFormula: "orchid −16% L" },
  "chart-10": {
    variable: "--chart-10",
    light: "202 98% 52%",
    dark: "202 98% 52%",
    originalFormula: "sky (#0FA5FC)",
  },
  "chart-10-lighter": { variable: "--chart-10-lighter", light: "202 98% 68%", dark: "202 98% 68%", originalFormula: "sky +16% L" },
  "chart-10-light":   { variable: "--chart-10-light",   light: "202 98% 60%", dark: "202 98% 60%", originalFormula: "sky +8% L" },
  "chart-10-dark":    { variable: "--chart-10-dark",    light: "202 98% 44%", dark: "202 98% 44%", originalFormula: "sky −8% L" },
  "chart-10-darker":  { variable: "--chart-10-darker",  light: "202 98% 36%", dark: "202 98% 36%", originalFormula: "sky −16% L" },
  "chart-positive": {
  ...
  "chart-9-muted": { variable: "--chart-9-muted", light: "291 50% 60% / 0.4",  dark: "291 50% 60% / 0.4",  originalFormula: "orchid at 40%" },
  "chart-10-muted": { variable: "--chart-10-muted", light: "202 98% 52% / 0.4", dark: "202 98% 52% / 0.4", originalFormula: "sky at 40%" },
