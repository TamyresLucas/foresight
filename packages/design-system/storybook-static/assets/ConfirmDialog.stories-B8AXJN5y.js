import{j as e}from"./jsx-runtime-BYYWji4R.js";import{r as i}from"./index-ClcD9ViR.js";import{c as x}from"./utils-CDN07tui.js";import{A as le,a as ce,b as de,c as ue,d as pe,e as me,f as fe,g as ge,h as he}from"./alert-dialog-BhKOmTg-.js";import{D as $,a as ee,b as ne,c as te,d as ae,e as se,f as re}from"./dialog-DDbrjtmT.js";import{B as s}from"./button-DY4UnA7S.js";import{ad as ve,ae as ye,w as xe}from"./icons-BXU3tp_f.js";import{I as C}from"./input-D4wTwlKS.js";import{L as j}from"./label-D3XcEZ0Y.js";function oe({type:t}){const n={destructive:{Icon:xe,className:"text-destructive",bgClassName:"bg-destructive/10"},informational:{Icon:ye,className:"text-success",bgClassName:"bg-success/10"},default:{Icon:ve,className:"text-primary",bgClassName:"bg-primary/10"}}[t],{Icon:o}=n;return e.jsx("div",{className:x("mx-auto flex h-12 w-12 items-center justify-center rounded-full",n.bgClassName),children:e.jsx(o,{className:x("h-6 w-6",n.className)})})}function be({title:t,description:a,confirmLabel:n="Delete",cancelLabel:o="Cancel",open:l,onOpenChange:c,onConfirm:d,onCancel:v,trigger:y,className:b}){return e.jsxs(le,{open:l,onOpenChange:c,children:[y&&e.jsx(ce,{asChild:!0,children:y}),e.jsxs(de,{className:x("sm:max-w-md",b),children:[e.jsxs(ue,{className:"sm:text-center",children:[e.jsx(oe,{type:"destructive"}),e.jsx(pe,{className:"mt-4",children:t}),e.jsx(me,{children:a})]}),e.jsxs(fe,{className:"sm:justify-center",children:[e.jsx(ge,{onClick:v,children:o}),e.jsx(he,{onClick:d,className:"bg-destructive text-destructive-foreground hover:bg-destructive/90",children:n})]})]})]})}function Ce({title:t,description:a,confirmLabel:n="Got it",open:o,onOpenChange:l,onConfirm:c,trigger:d,className:v}){return e.jsxs($,{open:o,onOpenChange:l,children:[d&&e.jsx(ee,{asChild:!0,children:d}),e.jsxs(ne,{className:x("sm:max-w-md",v),children:[e.jsxs(te,{className:"sm:text-center",children:[e.jsx(oe,{type:"informational"}),e.jsx(ae,{className:"mt-4",children:t}),e.jsx(se,{children:a})]}),e.jsx(re,{className:"sm:justify-center",children:e.jsx(s,{onClick:c,children:n})})]})]})}function je({title:t,description:a,confirmLabel:n="Save",cancelLabel:o="Cancel",open:l,onOpenChange:c,onConfirm:d,onCancel:v,trigger:y,children:b,className:ie}){return e.jsxs($,{open:l,onOpenChange:c,children:[y&&e.jsx(ee,{asChild:!0,children:y}),e.jsxs(ne,{className:x("sm:max-w-md",ie),children:[e.jsxs(te,{children:[e.jsx(ae,{children:t}),a&&e.jsx(se,{children:a})]}),b&&e.jsx("div",{className:"py-4",children:b}),e.jsxs(re,{children:[e.jsx(s,{variant:"outline",onClick:v,children:o}),e.jsx(s,{onClick:d,children:n})]})]})]})}function r({type:t="default",children:a,...n}){return t==="destructive"?e.jsx(be,{...n}):t==="informational"?e.jsx(Ce,{...n}):e.jsx(je,{...n,children:a})}try{r.displayName="ConfirmDialog",r.__docgenInfo={description:`ConfirmDialog - Reusable confirmation dialog component
...
- **default**: Standard dialog with form support`,displayName:"ConfirmDialog",props:{type:{defaultValue:{value:"default"},description:"Type of dialog determines styling and icon",name:"type",required:!1,type:{name:"enum",value:[{value:'"default"'},{value:'"destructive"'},{value:'"informational"'}]}},title:{defaultValue:null,description:"Dialog title",name:"title",required:!0,type:{name:"string"}},description:{defaultValue:null,description:"Dialog description/message",name:"description",required:!0,type:{name:"string"}},confirmLabel:{defaultValue:null,description:"Label for the confirm/action button",name:"confirmLabel",required:!1,type:{name:"string"}},cancelLabel:{defaultValue:null,description:"Label for the cancel button",name:"cancelLabel",required:!1,type:{name:"string"}},open:{defaultValue:null,description:"Whether the dialog is open (controlled mode)",name:"open",required:!1,type:{name:"boolean"}},onOpenChange:{defaultValue:null,description:"Callback when open state changes",name:"onOpenChange",required:!1,type:{name:"((open: boolean) => void)"}},onConfirm:{defaultValue:null,description:"Callback when confirm is clicked",name:"onConfirm",required:!1,type:{name:"(() => void)"}},onCancel:{defaultValue:null,description:"Callback when cancel is clicked",name:"onCancel",required:!1,type:{name:"(() => void)"}},trigger:{defaultValue:null,description:"Trigger element to open the dialog",name:"trigger",required:!1,type:{name:"ReactNode"}},children:{defaultValue:null,description:"Additional content (e.g., form fields)",name:"children",required:!1,type:{name:"ReactNode"}},className:{defaultValue:null,description:"Additional CSS classes for the dialog content",name:"className",required:!1,type:{name:"string"}}}}}catch{}const De={title:"Blocks/Dashboard UI/Confirm Dialogs",component:r,parameters:{layout:"centered"},argTypes:{type:{control:"select",options:["destructive","informational","default"],description:"Type of dialog that determines styling"},onConfirm:{action:"confirmed"},onCancel:{action:"cancelled"}}},u={args:{type:"destructive",title:"Delete Survey?",description:"This action cannot be undone. All survey data will be permanently removed.",confirmLabel:"Delete",cancelLabel:"Cancel"},render:t=>{const[a,n]=i.useState(!1);return e.jsx(r,{...t,open:a,onOpenChange:n,trigger:e.jsx(s,{variant:"destructive",children:"Delete Survey"})})}},p={args:{type:"informational",title:"Survey Published!",description:"Your survey has been published successfully and is now available to respondents.",confirmLabel:"Continue"},render:t=>{const[a,n]=i.useState(!1);return e.jsx(r,{...t,open:a,onOpenChange:n,trigger:e.jsx(s,{variant:"success",children:"Publish Survey"})})}},m={args:{type:"default",title:"Add Question",description:"Fill in the fields below to add a new question.",confirmLabel:"Add",cancelLabel:"Cancel"},render:t=>{const[a,n]=i.useState(!1);return e.jsx(r,{...t,open:a,onOpenChange:n,trigger:e.jsx(s,{children:"Add Question"}),children:e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"space-y-2",children:[e.jsx(j,{htmlFor:"question",children:"Question Text"}),e.jsx(C,{id:"question",placeholder:"Enter your question..."})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(j,{htmlFor:"type",children:"Question Type"}),e.jsx(C,{id:"type",placeholder:"e.g., Multiple Choice"})]})]})})}},f={args:{type:"destructive",title:"Remove Logic?",description:"The branching logic for this question will be removed. Affected questions will return to the default flow.",confirmLabel:"Remove Logic",cancelLabel:"Keep"},render:t=>{const[a,n]=i.useState(!1);return e.jsx(r,{...t,open:a,onOpenChange:n,trigger:e.jsx(s,{variant:"outline",children:"Remove Logic"})})}},g={args:{type:"informational",title:"Export Complete!",description:"Your file has been exported successfully. The download will start automatically.",confirmLabel:"OK"},render:t=>{const[a,n]=i.useState(!1);return e.jsx(r,{...t,open:a,onOpenChange:n,trigger:e.jsx(s,{variant:"outline",children:"Simulate Export"})})}},h={parameters:{layout:"padded"},render:()=>{const[t,a]=i.useState(!1),[n,o]=i.useState(!1),[l,c]=i.useState(!1);return e.jsxs("div",{className:"flex flex-wrap gap-4",children:[e.jsx(r,{type:"destructive",title:"Delete Survey?",description:"This action cannot be undone.",open:t,onOpenChange:a,trigger:e.jsx(s,{variant:"destructive",children:"Destructive"})}),e.jsx(r,{type:"informational",title:"Success!",description:"Operation completed successfully.",open:n,onOpenChange:o,trigger:e.jsx(s,{variant:"success",children:"Informational"})}),e.jsx(r,{type:"default",title:"Add Item",description:"Fill out the form.",open:l,onOpenChange:c,trigger:e.jsx(s,{children:"Form Dialog"}),children:e.jsxs("div",{className:"space-y-2",children:[e.jsx(j,{htmlFor:"name",children:"Name"}),e.jsx(C,{id:"name",placeholder:"Item name"})]})})]})}};var D,O,S,w,N;u.parameters={...u.parameters,docs:{...(D=u.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    type: "destructive",
    title: "Delete Survey?",
...
Features a red confirm button and warning icon.`,...(N=(w=u.parameters)==null?void 0:w.docs)==null?void 0:N.description}}};var L,A,I,q,F;p.parameters={...p.parameters,docs:{...(L=p.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    type: "informational",
...
}`,...(Q=(E=f.parameters)==null?void 0:E.docs)==null?void 0:Q.source},description:{story:"Specific use case: Confirming removal of survey logic.",...(K=(P=f.parameters)==null?void 0:P.docs)==null?void 0:K.description}}};var W,Y,M,H,U;g.parameters={...g.parameters,docs:{...(W=g.parameters)==null?void 0:W.docs,source:{originalSource:`{
  args: {
    type: "informational",
...
}`,...(M=(Y=g.parameters)==null?void 0:Y.docs)==null?void 0:M.source},description:{story:"Specific use case: Export completion confirmation.",...(U=(H=g.parameters)==null?void 0:H.docs)==null?void 0:U.description}}};var z,G,J,X,Z;h.parameters={...h.parameters,docs:{...(z=h.parameters)==null?void 0:z.docs,source:{originalSource:`{
  parameters: {
    layout: "padded"
  },
  render: () => {
